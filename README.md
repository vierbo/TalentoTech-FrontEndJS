...
*   **Renderizado Dinámico:** Los productos se cargan de forma asíncrona mediante JavaScript leyendo un archivo de datos local (`.json`).
*   **Gestión del Carrito de Compras:** Sistema funcional que permite añadir productos, calcular totales y actualizar un contador persistente en el menú de navegación.
*   **SEO & Accesibilidad (WCAG):** 
    *   Estructura HTML5 semántica y metatags descriptivas para optimizar motores de búsqueda.
    *   Navegación 100% fluida mediante teclado (`Tab`) con indicadores de foco (`:focus-visible`) visualmente claros.
    *   Textos alternativos (`alt`) y etiquetas descriptivas (`aria-label`) en todas las imágenes e iconos.
*   **Sección de Contacto:** Formulario completamente funcional e integrado para la recepción de mensajes.
*   **Diseño Responsivo:** Interfaz adaptada a dispositivos móviles, tabletas y computadoras de escritorio mediante CSS Flexbox y Media Queries.
